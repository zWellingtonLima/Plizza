...
export default function Hero() {
  return (
    <section className="bg-gradient-to-b from-gray-800 to-gray-950">
      <div className="grid grid-cols-2 max-w-7xl mx-auto pb-20">
        <div className="flex flex-col justify-center">
          <h1
            className={`${calisto.className} leading-tight text-white text-6xl items-start`}
          >
          ...
          <button
            className={`${calisto.className} text-2xl mt-12 py-4 px-12 bg-gradient-to-b from-orange-500 to-yellow-500 hover:from-orange-400 hover:to-yellow-400 rounded-xl self-start text-orange-950 hover:text-orange-800 shadow-md shadow-blue-200`}
          >
            Order Now
          </button>
